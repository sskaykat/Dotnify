...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    // Home
    "home.title": "Dotnify",
    "home.subtitle": "Manage DNS records across Cloudflare, Huawei Cloud, Tencent Cloud and Alibaba Cloud from one place.",
    ...
    "providers.tencentCloud": "Tencent Cloud",
    "providers.addDnspod": "Add Tencent Cloud provider",
    "providers.aliyunCloud": "Alibaba Cloud",
    "providers.addAliyun": "Add Alibaba Cloud provider",
    "providers.placeholderCloudflare": "My Cloudflare account",
    "providers.placeholderHuawei": "My Huawei Cloud account",
    "providers.placeholderDnspod": "My Tencent Cloud account",
    "providers.placeholderAliyun": "My Alibaba Cloud account",
    ...
    "providers.aliAkHint": "Your Alibaba Cloud AccessKey ID.",
    "providers.aliSkHint": "Your Alibaba Cloud AccessKey Secret.",
    ...
    "records.exportFormat": "Export format",
    "records.importFormat": "Import format",
    "records.conflictStrategy": "Conflict strategy",
    "records.skip": "Skip existing",
    "records.overwrite": "Overwrite existing",
    "records.append": "Append all",
    "records.skipDesc": "Skip if a record with the same name and type exists",
    "records.overwriteDesc": "Update existing records with the same name and type",
    "records.appendDesc": "Add all records regardless of duplicates",
    "records.importing": "Importing...",
    "records.importResult": "Created {created}, skipped {skipped}, updated {updated}",
    "records.importErrors": "Errors",
    "records.pasteOrUpload": "Paste content or upload a file",
    "records.preview": "Preview",
    "records.startImport": "Start import",
    "records.noRecordsToImport": "No valid records found",
    "records.importFailed": "Import failed",
    "records.exportFailed": "Export failed",
    "records.formatJson": "JSON",
    "records.formatJsonDesc": "Full fidelity, preserves all fields",
    "records.formatZonefile": "Zone File",
    "records.formatZonefileDesc": "BIND format, widely compatible",
    "records.formatCsv": "CSV",
    "records.formatCsvDesc": "Spreadsheet-friendly with extended columns",
    "records.importPreviewCount": "{count} record{s} will be imported",
    "records.parseErrors": "Parse errors ({count})",
    "records.close": "Close",
  ...
  "zh-CN": {
    ...
    // Home
    "home.title": "Dotnify",
    "home.subtitle": "在一个地方管理 Cloudflare、华为云、腾讯云和阿里云的 DNS 记录。",
    "home.providers": "服务商",
    "home.domains": "域名",
    "home.active": "活跃",
    ...
    "providers.tencentCloud": "腾讯云",
    "providers.addDnspod": "添加腾讯云服务商",
    "providers.aliyunCloud": "阿里云",
    "providers.addAliyun": "添加阿里云服务商",
    "providers.placeholderCloudflare": "我的 Cloudflare 账号",
    "providers.placeholderHuawei": "我的华为云账号",
    "providers.placeholderDnspod": "我的腾讯云账号",
    "providers.placeholderAliyun": "我的阿里云账号",
    ...
    "providers.aliAkHint": "你的阿里云 AccessKey ID。",
    "providers.aliSkHint": "你的阿里云 AccessKey Secret。",
    "providers.region": "区域",
    ...
    "records.proxiedHint": "Cloudflare 小黄云代理",
    "records.on": "开",
    "records.off": "关",
    "records.save": "保存",
    "records.create": "创建",
    "records.export": "导出",
    "records.import": "导入",
    "records.exportFormat": "导出格式",
    "records.importFormat": "导入格式",
    "records.conflictStrategy": "冲突策略",
    "records.skip": "跳过已有",
    "records.overwrite": "覆盖已有",
    "records.append": "全部追加",
    "records.skipDesc": "同名同类型记录已存在则跳过",
    "records.overwriteDesc": "同名同类型记录已存在则更新",
    "records.appendDesc": "无条件新增，可能产生重复记录",
    "records.importing": "导入中...",
    "records.importResult": "已创建 {created} 条，跳过 {skipped} 条，更新 {updated} 条",
    "records.importErrors": "错误",
    "records.pasteOrUpload": "粘贴内容或上传文件",
    "records.preview": "预览",
    "records.startImport": "开始导入",
    "records.noRecordsToImport": "未找到有效记录",
    "records.importFailed": "导入失败",
    "records.exportFailed": "导出失败",
    "records.formatJson": "JSON",
    "records.formatJsonDesc": "完整保留所有字段",
    "records.formatZonefile": "Zone File",
    "records.formatZonefileDesc": "BIND 格式，通用兼容",
    "records.formatCsv": "CSV",
    "records.formatCsvDesc": "电子表格友好，含扩展列",
    "records.importPreviewCount": "将导入 {count} 条记录",
    "records.parseErrors": "解析错误（{count}）",
    "records.close": "关闭",
