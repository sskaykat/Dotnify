...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    // Home
    "home.title": "Dotnify",
    "home.subtitle": "Manage DNS records across Cloudflare, Huawei Cloud, DNSPod and Alibaba Cloud from one place.",
  ...
  "zh-CN": {
    ...
    // Home
    "home.title": "Dotnify",
    "home.subtitle": "在一个地方管理 Cloudflare、华为云、DNSPod 和阿里云的 DNS 记录。",
    "home.providers": "服务商",
    "home.domains": "域名",
    "home.active": "活跃",
