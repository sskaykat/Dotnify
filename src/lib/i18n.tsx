...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "zones.searchPlaceholder": "Search domains…",
    ...
    "providers.addCloudflare": "Add Cloudflare provider",
    "providers.huaweiCloud": "Huawei Cloud",
    "providers.addHuawei": "Add Huawei Cloud provider",
    "providers.addDnspod": "Add DNSPod provider",
    "providers.placeholderCloudflare": "My Cloudflare account",
    "providers.placeholderHuawei": "My Huawei Cloud account",
    "providers.placeholderDnspod": "My DNSPod account",
    "providers.nameHint": "A label so you can tell providers apart later.",
    "providers.cfTokenHint": "We verify the token against Cloudflare, then let you pick zones.",
    "providers.hwAkHint": "Your Huawei Cloud access key ID.",
    "providers.hwSkHint": "Your Huawei Cloud secret access key.",
    "providers.dpSidHint": "Your Tencent Cloud SecretId.",
    "providers.dpSkHint": "Your Tencent Cloud SecretKey.",
  ...
  "zh-CN": {
    ...
    "zones.searchPlaceholder": "搜索域名…",
    "zones.allProviders": "全部服务商",
    ...
    "providers.secretId": "SecretId",
    "providers.secretKey": "SecretKey",
    "providers.addCloudflare": "添加 Cloudflare 服务商",
    "providers.huaweiCloud": "华为云",
    "providers.addHuawei": "添加华为云服务商",
    "providers.addDnspod": "添加 DNSPod 服务商",
    "providers.placeholderCloudflare": "我的 Cloudflare 账号",
    "providers.placeholderHuawei": "我的华为云账号",
    "providers.placeholderDnspod": "我的 DNSPod 账号",
    "providers.nameHint": "一个标签，方便之后区分不同服务商。",
    "providers.cfTokenHint": "我们会向 Cloudflare 验证令牌，然后让你选择域名。",
    "providers.hwAkHint": "你的华为云 Access Key ID。",
    "providers.hwSkHint": "你的华为云 Secret Access Key。",
    "providers.dpSidHint": "你的腾讯云 SecretId。",
    "providers.dpSkHint": "你的腾讯云 SecretKey。",
    "providers.region": "区域",
